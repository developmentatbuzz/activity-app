    ...
    <View style={tw`flex-1 bg-red-300`}>
      ...
      <View style={tw`flex h-1/4 mx-9`}>
        ...
        <View style={tw`mt-6 flex flex-row self-center`}>
          <TouchableOpacity style={tw`mt-4 rounded-2 bg-green-200 p-4 py-3 justify-center mr-3 flex-1`}>
          ...
          <TouchableOpacity style={tw`mt-4 rounded-2 bg-yellow-200 p-4 py-3 justify-center flex-1`}>
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <Pressable
              ...
              style={tw`flex flex-row items-center px-4 bg-gray-300 rounded-md  ${selectedTasks.includes(item.id) ? colorList[item.id % colorList.length] : "bg-gray-300"} h-17 mb-5`}
            >
